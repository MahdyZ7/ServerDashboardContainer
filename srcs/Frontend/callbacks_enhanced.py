...
from refresh_utils import get_refresh_status_message
...
def register_callbacks(app):
    ...
    def update_main_dashboard(n_intervals, refresh_clicks):
        ...
        try:
            ...
            toasts = [
                create_error_toast("Failed to update dashboard. Please try again.")
            ]
            return (
    ...
    def update_analytics_chart(server_name, time_range, n_intervals):
        ...
        try:
            ...
            fig.update_yaxes(
                ...
                range=[
                    0,
                    df["logged_users"].max() * 1.2
                    if not df["logged_users"].empty
                    else 10,
                ],
                row=2,
                col=2,
            ...
            return {}, html.Div(
                f"Error loading analytics for {server_name}",
            ...
            try:
                ...
                if export_data:
                    ...
                    if filepath:
                        ...
                        return dcc.send_file(filepath), create_toast_container(
                            [toast]
                        ).children
                    else:
